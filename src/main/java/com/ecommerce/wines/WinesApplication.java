...
public class WinesApplication {
	...
	public CommandLineRunner initData(ProductRepository productRepository){
		return args ->{
			...
			Product product1 = new Product(Category.white, "Goda", "Albariño grapes, following a rigorous and careful process to guarantee its varietal purity. " +
			...
			Product product2 = new Product(Category.white, "Gaudila", "Strict control in our own vineyards with manual harvest in 15kg boxes. Immediate transport to the " +
			...
			Product product3 = new Product(Category.red, "Gaudila sobre lías", "The grapes are destemmed upon entering the winery and macerated cold pre-fermentation of " +
			...
			Product product4 = new Product(Category.white, "Pájaro loco Godello", "The mixture of grapes is macerated at cold temperatures before being gently pressed " +
			...
			Product product5 = new Product(Category.red, "Pájaro loco Mencía", "The mixture of grapes is macerated at cold temperatures before being gently pressed by " +
			...
			Product product6 = new Product(Category.white, "Nervo", "Extensive control in the vineyard with manual harvest in 15kg boxes. Immediate transport to the " +
			...
			Product product23 = new Product(Category.white, "Conti Ducco Brut", "Produced in limited quantities, the high-quality wine project comes from a single vineyard " +
